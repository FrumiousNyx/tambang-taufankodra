...
const ProjectsPage: React.FC<{ slug?: string }> = ({ slug }) => {
  ...
  if (slug) {
    ...
    if (!project) {
      return (
        <Layout>
          <SEO title={t('navigation.projects')} description={t('projects.subtitle')} lang={language as any} />
    ...
    const projectTitle = language === 'zh' ? project.titleZh : language === 'en' ? project.titleEn : project.title;
    const projectDesc = language === 'zh' ? project.scopeZh : language === 'en' ? project.scopeEn : project.scope;

    return (
      <Layout>
        <SEO title={projectTitle} description={projectDesc} lang={language as any} />
        {/* Hero */}
        <section className="py-20 relative overflow-hidden" style={{ background: 'var(--gradient-hero)' }}>
          ...
          <div className="container-enterprise relative z-10">
            <Link href={withLang('/proyek', language)} className="inline-flex items-center text-primary-foreground/80 hover:text-primary-foreground mb-6 transition-colors">
          ...
          <div className="container-enterprise">
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="card-enterprise p-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {project.products.map((product, index) => (
                      <Link
                        key={index}
                        href={withLang(`/produk/${product.toLowerCase() === 'pcc' ? 'portland-composite-cement' : product.toLowerCase() === 'opc' ? 'ordinary-portland-cement' : 'sulfate-resistant-cement'}`, language)}
              ...
              <div className="space-y-6">
                ...
                <Link href={withLang('/kontak', language)}>
