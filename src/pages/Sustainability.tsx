...
const SustainabilityPage: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO title={t('navigation.sustainability')} description={t('sustainability.subtitle')} lang={language as any} />
      {/* Hero Section */}
          ...
          <ScrollReveal>
            ...
            <div className="max-w-4xl flex flex-col items-center text-center mx-auto">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <Link href={withLang('/investor', language)}>
          ...
          <ScrollReveal>
            <div className="card-enterprise p-12 text-center bg-gradient-to-br from-green-50 to-emerald-50 border-green-100">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Link href={withLang('/download', language)}>
