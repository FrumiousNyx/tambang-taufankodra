        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                ...
                rel="noreferrer"
                aria-label="LinkedIn"
                className="rounded-sm outline-none focus:ring-2 focus:ring-accent"
              >
                <Linkedin aria-hidden="true" className="w-5 h-5 text-slate-500 hover:text-accent transition-colors" />
              </a>
              <a
                ...
                className="rounded-sm outline-none focus:ring-2 focus:ring-accent"
              >
                <Instagram aria-hidden="true" className="w-5 h-5 text-slate-500 hover:text-accent transition-colors" />
              </a>
            </div>
          </div>
          ...
          <div>
             ...
             <ul className="space-y-4 text-sm font-medium text-slate-300">
               <li>
                 <Link href={withLang('/produk', language)} className="hover:text-accent">
                   {t('navigation.products')}
                 </Link>
               </li>
               <li>
                 <Link href={withLang('/proyek', language)} className="hover:text-accent">
                   {t('navigation.projects')}
                 </Link>
               </li>
               <li>
                 <Link href={withLang('/kontak', language)} className="hover:text-accent">
